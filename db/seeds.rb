...
User.destroy_all
User.create!([
  {login_id: 1, company_id: 1, street: "123 Front St", city: "Naperville", state: "IL", zip: 60504,  spouse_first_name: nil, spouse_middle_initial: nil, spouse_last_name: nil, number_children: nil, birth_month: 5, birth_day: 17, birth_year: 1992, ethnicity: "N/A", general_opt_in: nil, email_opt_in: nil, phone_opt_in: nil, badges_opt_in: nil, status: nil, salary_range: nil, job_title: nil, start_date: nil, end_date: nil, searchable: nil, subscription_type: nil}
  {login_id: 2, company_id: 2,  street: "345 Circle Dr", city: "Wheaton", state: "IL", zip: 60538,  spouse_first_name: nil, spouse_middle_initial: nil, spouse_last_name: nil, number_children: nil, birth_month: 11, birth_day: 24, birth_year: 1987, ethnicity: "Hispanic", general_opt_in: nil, email_opt_in: nil, phone_opt_in: nil, badges_opt_in: nil, status: nil, salary_range: nil, job_title: nil, start_date: nil, end_date: nil, searchable: nil, subscription_type: nil}
  {login_id: 3, company_id: 3,  street: "11212 Jefferson", city: "Sugar Grove", state: "IL", zip: 60554,  spouse_first_name: "Taylor", spouse_middle_initial: "M", spouse_last_name: "Clarkson", number_children: 2, birth_month: 3, birth_day: 13, birth_year: 1977, ethnicity: "Caucasian", general_opt_in: nil, email_opt_in: nil, phone_opt_in: nil, badges_opt_in: nil, status: nil, salary_range: nil, job_title: nil, start_date: nil, end_date: nil, searchable: nil, subscription_type: nil}
  {login_id: 4, company_id: 4,  street: "317 Ogden Ave", city: "Oswego", state: "IL", zip: 60543,  spouse_first_name: nil, spouse_middle_initial: nil, spouse_last_name: nil, number_children: nil, birth_month: 4, birth_day: 16, birth_year: 1990, ethnicity: "Caucasian", general_opt_in: nil, email_opt_in: nil, phone_opt_in: nil, badges_opt_in: nil, status: nil, salary_range: nil, job_title: nil, start_date: nil, end_date: nil, searchable: nil, subscription_type: nil}
])
<<<<<<< HEAD
GivingBack.destroy_all
GivingBack.create!([
  {user_id: 4, company_id: 3, subject: "Guest Speaker", position: "QA", description: "I'd like to give a guest presentation to the Computer Science department", requirements: nil, approved: nil, completed: nil, type: 2, contact_first_name: "Sue", contact_last_name: "King", contact_email: "sueking@hotmail.com"},
  {user_id: 3, company_id: 2, subject: "Tutor", position: "Tutor", description: "Computer Science tutor", requirements: nil, approved: nil, completed: nil, type: 3, contact_first_name: "Jake", contact_last_name: "Smith", contact_email: "jstutor@gmail.com"}
  {user_id: 4, company_id: 3, subject: "Mentor", position: "Mentor", description: "Willing to mentor students in the Math department.", requirements: nil, approved: nil, completed: nil, type: 1, contact_first_name: "Carl", contact_last_name: "Dyer", contact_email: "carlthementor@gmail.com"}
  {user_id: 3, company_id: 2, subject: "Internship", position: "Jr. Java Developer", description: "Entry level position for students with a degree in CS", requirements: "Undergrad in Computer Science", approved: nil, completed: nil, type: 0, contact_first_name: "Laura", contact_last_name: "Fisher", contact_email: "lfish@gmail.com"}
])
